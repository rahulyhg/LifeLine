...
import com.example.lifeline.models.DistanceDuration;
...
public class hospitals_locator extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospitals_locator);
...
//                addMapMarker(new LatLng(28.6566,77.18432),"Test loc","testing");
    ...
    void getDistance(){
        ...
        SinglePlace place = placeList.places.get(placeList.places.size());
        destination += place.getLoc().latitude+ "," +place.getLoc().longitude;
